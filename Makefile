...
update-server:
	@source ./secrets/.env.prod && rsync -chavzP --stats --include='caddy/Caddyfile' --include='secrets/***' --include='docker-compose.yml' --include='Makefile' --exclude='*' ./ ${VPS_USER}@${VPS_ADDRESS}:${REMOTE_WORKING_FOLDER}
